...
import { User } from "@/models/userDetails"; // Import the User model
...
async function getCourseDetails(slug: string) {
  ...
  //   (course.instructor as any)._id = course.instructor._id.toString();
  //   (course.instructor.user as any)._id = course.instructor.user._id.toString();
  //   course.courses = course.courses.map((c: mongoose.Types.ObjectId) =>
  //     c.toString()
  //   );

  //   //   course.instructor._id = course.instructor._id.toString();
  //   //   course.instructor.user._id = course.instructor.user._id.toString();
  //   // course.courses = course.courses.map((c: mongoose.Types.ObjectId) => c.toString());
  // }
...
export default async function CourseDetailsPage({
  ...
  // const isEnrolled =
  //   session?.user && course.enrolledStudents.includes(session.user.id);
  // const isEnrolled =
  //   session?.user &&
  ...
  //     studentId.equals(new mongoose.Types.ObjectId(session.user.id))
  //   );

  // const isEnrolled =
  //   session?.user &&
  //   course.enrolledStudents.some((studentId) => {
  //     const studentObjectId = new mongoose.Types.ObjectId(studentId.toString()); // Ensure correct format
  //     return studentObjectId.equals(
